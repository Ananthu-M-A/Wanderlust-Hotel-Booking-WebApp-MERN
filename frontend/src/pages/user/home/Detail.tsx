    ...
    return (
        <>
            <Helmet>
                ...
                <meta name="description" content={hotel.description?.slice(0, 150) || 'Hotel details'} />
                <meta property="og:title" content={hotel.name} />
                <meta property="og:description" content={hotel.description?.slice(0, 150) || 'Hotel details'} />
                {hotel.imageUrls[0] && <meta property="og:image" content={hotel.imageUrls[0]} />}
            </Helmet>
